...
const markup = images
  .map(
    image => `<li class="list-item"><img src="${image.url}", alt="${image.alt}", width=300></li>`
  )
  .join('');
...
ulItem.style.flexWrap = 'wrap';
ulItem.style.justifyContent = 'center';
ulItem.style.alignItems = 'center';
ulItem.style.listStyle = 'none';
ulItem.style.gap = '16px';
